...
if (isset($_GET['categories_id']) && $_GET['categories_id'] != '') {
    $id = get_safe_value($con, $_GET['categories_id']); // Fetching and sanitizing ID
} else {
    $id = ''; // Assigning a default empty value
}
...
if (isset($_POST['submit'])) {
    ...
    if ($check > 0) {
        ...
        if ($id != '' && $id == $getData['categories_id']) {
            // Allow update if the category is the same as the current one
        } else {
    ...
    if ($msg == '') {
        if ($id != '') {
            ...
            mysqli_query($con, "UPDATE categories SET category_name='$categories' WHERE categories_id='$id'");
        } else {
            // Insert new category
            mysqli_query($con, "INSERT INTO categories(category_name, status) VALUES ('$categories', '1')");
        }
                    ...
                    <div class="main-content">
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                ...
                                <!-- new-category --> <!-- this is new category form start-->

                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" action="add_category.php" method="POST">
                                        enctype="multipart/form-data">
                                        <fieldset class="name">
                                            <div class="body-title">Category Name <span class="tf-color-1">*</span>
                                            </div>
                                         <input class="flex-grow" type="text" placeholder="Category_name" name="categories">
