...
if(isset($_POST['add_product'])){
   ...
   if (!empty($p_name) && !empty($category_name) && !empty($brand_name) && !empty($mrp) && !empty($p_price) && !empty($qty)) {
       $insert_query = "INSERT INTO products(p_name, category_name, brand_name, mrp, p_price, qty, p_image, short_desc, description, meta_title, meta_desc, meta_keyword) 
...
<body>
    ...
    <textarea name="short_desc" placeholder="Write short description"></textarea>
